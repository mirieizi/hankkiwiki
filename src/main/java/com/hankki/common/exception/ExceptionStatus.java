...
public enum ExceptionStatus {
	...
	NOT_FOUND_DIET(HttpStatus.BAD_REQUEST, 400, "식사 정보가 존재하지 않습니다."),
	NOT_FOUND_DIET_MEAL_ITEM(HttpStatus.BAD_REQUEST, 400, "식사에 대응하는 음식 정보를 찾지 못했습니다."),
	NOT_FOUND_MEAL_ITEM(HttpStatus.BAD_REQUEST, 400, "음식 정보가 존재하지 않습니다."),
